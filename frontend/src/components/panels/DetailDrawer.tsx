...
class DetailErrorBoundary extends Component<EBProps, EBState> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="fixed top-[72px] left-[296px] w-[320px] z-30 p-4 text-[13px] text-rose-400 bg-zinc-900 rounded-xl border border-rose-500/30 shadow-2xl">
...
function DetailContent() {
  ...
  return (
    <div className="fixed top-14 left-[280px] bottom-0 w-[340px] z-30 bg-zinc-900 border-r border-zinc-800 flex flex-col">
      {/* Sticky header */}
